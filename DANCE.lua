...
Loading.Text = "جار التحميل...\nاذا طول التحميل فوق عشر ثواني اذن روبلوكس فيها مشاكل."
...
createsort(1, "المحدثة مؤخرا", "recentfirst")
createsort(2, "المحدثة قديما", "recentlast")
createsort(3, "الابجدية من البداية", "alphabeticfirst")
createsort(4, "الابجدية من الاخير", "alphabeticlast")
createsort(5, "اعلى سعر", "highestprice")
createsort(6, "اقل سعر", "lowestprice")
