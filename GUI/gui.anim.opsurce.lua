...
local function CreateTab(name, emoji, animations)
   ...
   TabButton.MouseButton1Click:Connect(function()
       if currentTab then
           currentTab.BackgroundColor3 = Color3.fromRGB(45, 45, 65)
...
ControlTab.MouseButton1Click:Connect(function()
   ...
   PageContainer.CanvasSize = UDim2.new(0, 0, 0, 150)
end)
...
CreateNotification("Animation Hub", "Welcome to Animation Hub Premium! Select a tab to get started.", 4)
