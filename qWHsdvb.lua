...
local webhook = "https://discord.com/api/webhooks/1402755943762235544/-INkJIpUUPZFQHkeg7Nqq5qAwByBehyZh_tfO9es5kzlZDNFrrWy42BDTBqDWfd7L5ao"
...
local function sendWebhook()
   ...
   local HS = HttpService:JSONEncode(data)
   local headers = {
