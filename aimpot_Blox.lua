...
ocal PlkFarmPlayer = Tabs.Player:AddSection("Infinite Jump")
local SpeedJumpPlayer = Tabs.Player:AddSection("Speed & Jump")
local NoClipPlayer = Tabs.Player:AddSection("اNoClip")
...
--[[
local FaemFofSE = Tabs.Setting:AddSection("Remove Fog")
local FarmFpsQuSetting = Tabs.Setting:AddSection("Fps & Quailte")
